...
- Directory layout:
  - `tests/marketplaceSystem.test.js` - Covers the rotating catalog, premium limits, ticket receipts, PayPal configuration, persistence, and Lemon-Quake Boots.
  - `tests/mission6Navigation.test.js` - Verifies the complete Blacksite route in both directions.
