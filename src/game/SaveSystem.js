...
const DEFAULT_SAVE = { chips: 750, missionsWon: 0, totalKills: 0, mmr: 1000, rankedWins: 0, rankedLosses: 0, modeRecords: { deathmatch: defaultModeRecord(), domination: defaultModeRecord() }, aiProfiles: [], betHistory: [], blueprints: ['pistol', 'scout'], gear: [], upgrades: {}, cosmetics: [], equipped: { hat: null, skin: null }, settings: SETTINGS_DEFAULTS };
...
export class SaveSystem {
  ...
  load() {
    try {
      ...
      return { ...structuredClone(DEFAULT_SAVE), ...saved, modeRecords, equipped: { ...DEFAULT_SAVE.equipped, ...(saved.equipped || {}) }, settings: { ...SETTINGS_DEFAULTS, ...(saved.settings || {}) } };
