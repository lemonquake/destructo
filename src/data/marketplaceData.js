...
export const MARKETPLACE_COSMETICS = Object.freeze([
  ...
  cosmetic('red-plasma','projectile','Red Plasma',700,'epic','Crimson plasma spheres with a white-hot core.',{model:'plasma',primary:0xff3d57,secondary:0xffc2ca}),
  cosmetic('yellow-plasma','projectile','Yellow Plasma',700,'epic','Solar-yellow plasma spheres that flare in flight.',{model:'plasma',primary:0xffd23f,secondary:0xfff2a3}),
  cosmetic('purple-plasma','projectile','Purple Plasma',700,'epic','Deep-violet plasma spheres charged with arc energy.',{model:'plasma',primary:0xa35cff,secondary:0xe0c2ff}),
  cosmetic('pink-plasma','projectile','Pink Plasma',700,'epic','Hot-pink plasma spheres with a bright neon bloom.',{model:'plasma',primary:0xff4f91,secondary:0xffc4dc}),
  cosmetic('blue-plasma','projectile','Blue Plasma',700,'epic','Electric-blue plasma spheres wrapped in cool sparks.',{model:'plasma',primary:0x2fb4ff,secondary:0xbcecff}),
  cosmetic('green-plasma','projectile','Green Plasma',700,'epic','Reactive-green plasma spheres with a toxic glow.',{model:'plasma',primary:0x59e065,secondary:0xc7ffc9}),
  cosmetic('red-pellet','projectile','Red Pellet',400,'rare','Compact red pellets with a sharp ballistic glow.',{model:'pellet',primary:0xff3d57,secondary:0xffc2ca}),
  cosmetic('blue-pellet','projectile','Blue Pellet',400,'rare','Compact blue pellets that streak like tiny comets.',{model:'pellet',primary:0x2fb4ff,secondary:0xbcecff}),
  cosmetic('yellow-pellet','projectile','Yellow Pellet',400,'rare','Compact yellow pellets with a bright muzzle sparkle.',{model:'pellet',primary:0xffd23f,secondary:0xfff2a3}),
  cosmetic('pink-pellet','projectile','Pink Pellet',400,'rare','Compact pink pellets with a playful neon trail.',{model:'pellet',primary:0xff4f91,secondary:0xffc4dc}),
  cosmetic('purple-pellet','projectile','Purple Pellet',400,'rare','Compact purple pellets pulsing with void light.',{model:'pellet',primary:0xa35cff,secondary:0xe0c2ff}),
  cosmetic('green-pellet','projectile','Green Pellet',400,'rare','Compact green pellets glowing with reactor energy.',{model:'pellet',primary:0x59e065,secondary:0xc7ffc9}),
